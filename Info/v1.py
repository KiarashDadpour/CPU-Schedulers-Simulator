    ...
    for line in lines:
        ...
        while "<" in line and ">" in line:
            ...
            if tag.startswith("/"):
                ...
                # Handle opening tags
                if tag == "strong":
                    text_widget.tag_configure(tag, font=("Arial", 10, "bold"))
                elif tag == "em":
                    text_widget.tag_configure(tag, font=("Arial", 10, "italic"))
                elif tag == "p":
...
root = tk.Tk()
root.title("HTML-like Content in Tkinter")

# Create a Text widget
text_widget = tk.Text(root, wrap="word", font=("Arial", 10), padx=10, pady=10)
